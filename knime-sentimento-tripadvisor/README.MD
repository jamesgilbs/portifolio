...
#### Aquisição dos dados
  Os dados foram adquiridos de uma base de dados da empresa Tripadvisor, sendo uma base já inserida no projeto e que está em lingua englesa.
<p align="center">
  <img width="55%" height="55%" src="figures/preparacao-da-base.png">
</p>
